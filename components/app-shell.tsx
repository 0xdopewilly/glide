...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div
      className="app-shell-root glide-full-screen fixed inset-0 flex w-full flex-col md:items-center md:justify-center md:p-8"
      style={{ backgroundColor: "var(--glide-chrome)" }}
    >
