...
/** Navy sign-in card for dark mode (the glidepay.cash palette). */
const darkAppearance = {
  ...
  elements: {
    ...
    formButtonPrimary:
      "!bg-[#5B3DF5] !text-white hover:!bg-[#4A2EE0] !shadow-none !rounded-full py-3 h-auto text-sm font-semibold normal-case",
    otpCodeFieldInput:
      "!bg-[#0A2F5C] !border-[rgba(255,255,255,0.08)] !text-white caret-[#5B3DF5]",
    footerActionLink: "!text-[#9D86FF] !font-semibold",
    footerActionText: "!text-[#A9B7D0]",
    dividerLine: "!bg-[rgba(255,255,255,0.08)]",
    dividerText: "!text-[#A9B7D0]",
    identityPreviewEditButton: "!text-[#9D86FF]",
    identityPreviewText: "!text-white",
    formResendCodeLink: "!text-[#9D86FF]",
    alternativeMethodsBlockButton: "!text-[#9D86FF]",
